...
export default function NewCreditorScreen() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setErrors(prev => ({
        ...prev,
        submit: 'Failed to create creditor. Please try again.'
      }));
    } finally {
      setLoading(false);
    }
      ...
      <View style={styles.container}>
        <View style={styles.emptyState}>
          ...
          <Text style={styles.emptySubtitle}>
            Please select a business to add a creditor
          </Text>
          <Button 
            mode="contained"
        ...
        <View style={styles.headerContent}>
          <View style={styles.titleContainer}>
            ...
            <View style={styles.titleWrapper}>
              <Text style={styles.headerTitle}>Add New Creditor</Text>
              <Text style={styles.headerSubtitle}>Enter creditor details</Text>
            </View>
          </View>
        </View>
      </LinearGradient>
